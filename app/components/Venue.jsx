...
const Venue = () => {
    return (
        ...
        >
            ...
            {/* Main content */}
            <div className="relative  items-center justify-center flex top-1/2  -translate-y-1/2  rounded-t-full max-w-xl h-[90%] md:h-[90vh] mx-auto bg-white/60 backdrop-blur-md shadow-2xl rounded-2xl p-8 md:p-12 pt-20 text-center space-y-4">
