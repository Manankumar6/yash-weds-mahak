...
const coupleData = [
   {
    role: "The Groom",
    name: "Aarav Sharma",
    sonOf: "Mr. Rajesh Sharma & Mrs. Kavita Sharma",
    profession: "Software Engineer at TechNova Pvt. Ltd.",
  ...
  },
  {
    role: "The Bride",
    name: "Meera Patel",
    sonOf: "Mr. Mahesh Patel & Mrs. Sunita Patel",
...
export const venueData = {
  ...
  mapLink: "https://maps.app.goo.gl/hBiDEMtbENoooEAS7",
  backgroundImage: "/images/venue-bg.png",
};

export const galleryData = [
  {
    src: "https://luxaus.au/wp-content/uploads/2023/03/cccc-scaled.webp",
